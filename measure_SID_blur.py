...
def test(epoch, gpu):
    ...
    for index in range(1,257):
        ...
        label_dir = '../dataset/Sony_total_dark/test/long/' + fill_index + "/"
        if os.path.exists(test_dir + fill_index):
            ...
            print("===> Avg.PSNR: {:.3f} dB ".format(i_psnr/i_n))
            print("===> Avg.SSIM: {:.3f} ".format(i_ssim/i_n))
    ...
    with open('result.txt', 'a') as file:
        file.write("===> Epoch[{}]: PSNR: {:.3f} || SSIM: {:.3f} || LPIPS: {:.3f}.\n".format(i,
            avg_psnr/n,avg_ssim/n,avg_lpips/n))
    print("===> Epoch[{}]: PSNR: {:.3f} dB || SSIM: {:.3f} || LPIPS: {:.3f}.\n".format(i,
        avg_psnr/n,avg_ssim/n,avg_lpips/n))
