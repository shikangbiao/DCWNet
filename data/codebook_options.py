...
def option():
    ...
    parser.add_argument('--L1_weight', type=float, default=2.0)
    parser.add_argument('--P_weight', type=float, default=0.01)
    parser.add_argument('--adv_weight', type=float, default=1.0)
    parser.add_argument('--hv_L1_weight', type=float, default=0.1)
    parser.add_argument('--codebook_weight', type=float, default=10.0)
