...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='DCWNet')
    ...
    parser.add_argument('--data_train_lolv2_syn'    , type=str, default='/home/data/cwtnet/datasets/LOLv2/Synthetic/Train')
    ...
    parser.add_argument('--data_val_lolv2_syn'      , type=str, default='/home/data/cwtnet/datasets/LOLv2/Synthetic/Test/Low')
    ...
    parser.add_argument('--data_valgt_lolv2_syn'    , type=str, default='/home/data/cwtnet/datasets/LOLv2/Synthetic/Test/Normal/')
    ...
    # loss weights
    parser.add_argument('--HVI_weight', type=float, default=0.05)
    parser.add_argument('--L1_weight', type=float, default=1.02)
    ...
    parser.add_argument('--codebook_weight', type=float, default=2.0)
